...
export const caseStudies: CaseStudy[] = [
  {
    ...
    excerpt:
      "NovaTech Distribution deployed AsterLogix's Demand Forecasting Agent across 12 product categories — slashing forecast error, reducing stockouts by 60%, and freeing two full-time planners.",
...
AsterLogix deployed a Demand Forecasting Agent trained on three years of NovaTech's sales history, combined with external signals including promotional calendars, competitor pricing data, and macroeconomic indicators. The agent generates weekly demand forecasts at the SKU-location level and automatically triggers replenishment orders when inventory hits dynamically calculated reorder points.
...
NovaTech has since expanded to AsterLogix's Procurement Automation Agent and is evaluating the full stack deployment for Q1 2027.`,
  },
  {
    slug: "manufacturer-automates-procurement-cycle",
    title: "Automating procurement for a mid-market manufacturer",
    excerpt:
      "Apex Manufacturing deployed AsterLogix's Procurement Agent to evaluate suppliers, generate POs, and manage approvals — cutting procurement cycle time by 40% and eliminating $320K in annual maverick spend.",
...
AsterLogix deployed a Procurement Automation Agent that integrates directly with Apex's SAP ECC system. The agent monitors inventory levels and production schedules, automatically generates purchase orders when materials are needed, evaluates suppliers based on historical performance (price, quality scores, lead time reliability), and routes approvals through Slack with one-click authorization.
...
The agent processes approximately 1,200 purchase orders per month with a 99.2% accuracy rate. Apex is now in the expansion phase, adding the Inventory Optimization Agent to create an integrated procurement-inventory system.`,
  },
  {
    ...
    excerpt:
      "When tariffs shifted and a key port faced congestion, AsterLogix's Disruption Agent had already flagged alternate suppliers and rerouted three critical shipments for Pacific Imports Group.",
...
Pacific Imports now runs the full AsterLogix stack: Disruption Monitoring, Procurement Automation, and the Visibility Dashboard — giving their 8-person operations team capabilities that previously would have required 20+ analysts.`,
  },
];
