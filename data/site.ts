  ...
  testimonials: [
    {
      ...
      quote:
        "Experidium cut our demand forecast error from 31% to 14% in six weeks. Our stockout rate dropped by 60% and we've freed up two full-time planners.",
    },
    {
      name: "Marcus Chen",
    ...
    },
    {
      ...
      quote:
        "Compliance in pharma supply chain is brutal. Experidium built agents that handle supplier qualification docs, expiry tracking, and cold-chain alerts — things we were doing manually across four systems.",
    },
  ],
  fleetFeatures: [
